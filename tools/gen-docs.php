...
/**
 * Generates the static API reference site for milpa/command.
 *
 ...
 * milpa/command has zero package dependencies at runtime): reflects over
...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Command',
    nsPrefix: 'Milpa\\Command\\',
    installCommand: 'composer require milpa/command',
    repoUrl: 'https://github.com/getmilpa/command',
    pagesUrl: 'https://getmilpa.github.io/command/',
    heroParagraph: 'The <strong>Command-as-atom</strong> core of Milpa: one surface-agnostic '
        . '<code>Operation</code> value object — schema of inputs + handler + metadata — plus the '
        . '<code>CommandProvider</code> and <code>SurfaceProjector</code> contracts. One operation, '
        . 'N surfaces: CLI, MCP, HTTP, web, TUI.',
    utmContent: 'command',
);
